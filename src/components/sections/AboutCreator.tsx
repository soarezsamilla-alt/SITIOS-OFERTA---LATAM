      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="text-center mb-4">
          ...
          <h2 className="text-lg md:text-xl font-bold font-headline text-foreground mb-1">
            Quién está detrás del <span className="text-primary italic">Plan Rural</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-stretch">
          ...
          <div className="bg-secondary/20 rounded-[10px] p-3 border-t-2 border-t-[#C9A961] border-x border-b border-[#C9A961]/10 shadow-sm transition-all duration-300 hover:-translate-y-1 flex flex-col items-center">
            <div className="text-center mb-2">
              <span className="text-[#C9A961] text-[7px] font-bold tracking-[0.15em] uppercase">SOBRE EL CREADOR</span>
            ...
            <p className="text-[#C9A961] italic text-[10px] mb-2">Fundador y Creador</p>

            <p className="text-white/70 text-center text-[10px] leading-relaxed mb-3 max-w-[240px]">
              Ingeniero agrónomo con más de 15 años de experiencia en planificación rural en toda Latinoamérica. Ha visitado más de 3.000 fincas en 8 países, desde México hasta Argentina. Su misión es democratizar el conocimiento rural profesional.
            </p>
            ...
            <div className="w-full pt-2 border-t border-[#C9A961]/10 flex justify-around gap-1 mt-auto">
              <div className="text-center">
                ...
                <div className="text-[6px] uppercase text-white/50 leading-tight">años exp.</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-[6px] uppercase text-white/50 leading-tight">productores</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-secondary/20 rounded-[10px] p-3 border-t-2 border-t-[#C9A961] border-x border-b border-[#C9A961]/10 shadow-sm transition-all duration-300 hover:-translate-y-1 flex flex-col items-center">
            <div className="text-center mb-2">
              <span className="text-[#C9A961] text-[7px] font-bold tracking-[0.15em] uppercase">CÓMO LO RECIBES</span>
              <div className="w-6 h-[1px] bg-[#C9A961] mx-auto mt-0.5"></div>
            </div>

            <h3 className="text-base font-headline font-bold text-white mb-2 text-center">Acceso Rápido</h3>
            ...
            <div className="w-full space-y-1.5 flex-1">
              {[
                { title: "Pago", desc: "Acceso inmediato tras la confirmación.", icon: "1" },
                { title: "E-mail", desc: "Recibe usuario y clave automáticos.", icon: "2" },
                { title: "De por vida", desc: "Descarga PDFs en cualquier país.", icon: "3" },
                { title: "Gratis", desc: "Actualizaciones incluidas por siempre.", icon: "4" }
              ].map((step, idx) => (
