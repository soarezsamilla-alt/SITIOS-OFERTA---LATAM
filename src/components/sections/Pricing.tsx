      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center max-w-5xl mx-auto">
          ...
          <div className="bg-secondary/20 p-8 rounded-3xl border-2 border-primary flex flex-col items-center text-center relative shadow-2xl scale-105 max-w-md w-full">
            ...
            <Button className="w-full py-6 text-lg font-bold gold-gradient text-background hover:scale-105 transition-all shadow-xl shimmer-btn animate-pulse-gold">RECIBIR ACCESO AHORA</Button>
